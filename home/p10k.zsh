# Generated by Powerlevel10k configuration wizard on 2020-07-16 at 13:00 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=8
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=8
  ...
  #####################################[ swap: used swap ]######################################
  # Swap color.
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=8
  typeset -g POWERLEVEL9K_SWAP_BACKGROUND=11
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=8
  ...
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=0
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LARAVEL_VERSION_BACKGROUND=0
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_JAVA_VERSION_BACKGROUND=0
  ...
  typeset -g POWERLEVEL9K_PLENV_PROMPT_ALWAYS_SHOW=true
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%a %b %d %Y %Z  %I:%M:%S %p %Z}'
